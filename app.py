...
# ---------------------------
#  Aesthetic CSS Styling (FINAL ATTEMPT FIX FOR TOP BAR)
# ---------------------------
st.markdown(
    """
    <style>
    /* ----------------------------------------------------------------- */
    /* FINAL NUCLEAR LAYOUT FIX: ELIMINATE THE TOP WHITE BAR/PADDING */
    /* ----------------------------------------------------------------- */
    ...
    /* 6. Target the Streamlit Header element generated by st.header() or hidden header */
    header {
        visibility: hidden;
        height: 0;
        margin: 0 !important;
    ...
    /* 7. Target the container specific to the content generated by st.header("") */
    .stHeader {
        height: 0 !important;
        margin: 0 !important;
        padding: 0 !important;
    ...
    /* ----------------------------------------------------------------- */
    /* THEME & FONT STYLING (The rest of the good styles)                */
    /* ----------------------------------------------------------------- */
...
# FINAL FIX: Insert an empty Streamlit header and target its class in CSS (stHeader) 
# to ensure the reserved space at the top is zeroed out.
st.header("")
